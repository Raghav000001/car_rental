...
const sideImages = [
  {
    src: "https://images.unsplash.com/photo-1485291571150-772bcfc10da5?q=80&w=1000",
...
export function TechnologySection() {
  ...
  const descriptionText = "Drive with confidence and style in our premium rental vehicles. Every car is meticulously maintained with state-of-the-art safety features, luxurious interiors, and advanced technology. Whether you&apos;re exploring city streets or scenic highways, your perfect ride awaits.";
  ...
  return (
    <section id="features" ref={sectionRef} className="relative bg-foreground">
          ...
          >
            ...
            >
              <Image
                ...
                alt="Premium Mercedes on the road"
                fill
                className="object-cover"
              />
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Comfort", "Meets", "Luxury."].map((word, index) => {
